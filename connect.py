...
def getAudio():from flask import Flask, render_template, request, url_for, redirect, url_for
#from string import Template
#import Requests
import os
...
@app.route('/getAudio')    
def getAudio():
    mixFile = mixAudio("Bailando.wav", "tearinmyheart.wav", "riverflowsinyou.wav")
    return mixFile
